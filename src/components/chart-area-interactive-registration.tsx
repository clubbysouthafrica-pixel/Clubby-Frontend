...
export function ChartAreaInteractiveRegistration({ data }: props) {
  const isMobile = useIsMobile()
  const [_timeRange, setTimeRange] = React.useState("90d")
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle>{data.row_name}</CardTitle>
        {/* <CardDescription>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        ...
        >
          <AreaChart data={data.data}>
            ...
            />
            <Area
              dataKey="total_registered_members"
              type="natural"
              fill="url(#fillMobile)"

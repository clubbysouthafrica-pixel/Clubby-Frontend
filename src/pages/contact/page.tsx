                ...
                <div className="container mx-auto px-4 py-24 relative">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-in slide-in-from-bottom-4 duration-700 delay-200">
                            Ready to transform your club management? We're here to help you every step of the way.
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <p className="text-green-600 font-medium">Available during business hours</p>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <p className="text-blue-600 font-medium">Cape Town, South Africa</p>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
            ...
            <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-background border-t border-primary/10">
                <div className="container mx-auto px-4 py-16 text-center">
                    <div className="max-w-2xl mx-auto space-y-6">
                        ...
                        <p className="text-muted-foreground">
                            Join hundreds of clubs that have already transformed their management experience.
                        </p>

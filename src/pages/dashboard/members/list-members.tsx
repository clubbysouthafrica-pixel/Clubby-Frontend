                    ...
                    <Table>
                        ...
                        <TableBody>
                            {clubMembers?.registered?.length ? clubMembers.registered.map((member: ClubMember) => (
                                ...
                                <TableCell>{member.member_first_name  + " " + member.member_surname}</TableCell>
                                <TableCell>{member.member_email}</TableCell>
                                <TableCell>{formatAmount(member.outstanding_amount, club?.currency)}</TableCell>
                    ...
                    <Table>
                        <TableHeader className="bg-muted sticky top-0 z-10">
                            <TableRow>
                                <TableHead>Display Name</TableHead>
                                {/* <TableHead>Billing Type</TableHead> */}
                                <TableHead>Registration Submitted</TableHead>
                                <TableHead>Reference Numbers</TableHead>
                                <TableHead>Outstanding Amount</TableHead>

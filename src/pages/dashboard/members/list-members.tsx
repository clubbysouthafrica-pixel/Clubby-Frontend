...
export default function ListMembersPage() {
    ...
    return (
        <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <TabsList className="w-[1000px]">
                            <TabsTrigger value="registered-members">
                                Active Members <Badge variant="secondary">{registeredMembersLength}</Badge>
                            </TabsTrigger>
                            <TabsTrigger value="pending-members">
                                Members Pending <Badge variant="secondary">{unregisteredMembersLength}</Badge>
                            </TabsTrigger>
                            <TabsTrigger value="previous-members">
                                Deregistered Members <Badge variant="secondary">{deregisteredMembersLength}</Badge>
                            </TabsTrigger>
                        </TabsList>
                    </div>
            ...
            {
                hashUserId && <SelectedMember clubName={club?.club_name ?? ""} selectedMember={selectedMember} setSelectedMember={setSelectedMember} currency={club?.currency ?? "ZAR"} clubAccountId={club?.club_account_id ?? ""} />
            }
        </div>
    );
}
            ...
            <CardDescription className="mb-4">
                <>
                    ...
                    <p className="text-sm leading-relaxed mt-3">
                        An email containing a temporary password will be sent to the member, granting them access to the Member Portal, where they can manage their membership details.
                    </p>
                    <p className="text-xs mt-2 p-2 bg-yellow-50 border border-yellow-200 rounded-lg text-yellow-800">
                        ⚠️ <strong>Important:</strong> Please ensure that a valid email address is provided to ensure successful communication and account registration.
                    </p>
                </>
            </CardDescription>
            {
                ...
                <div className="flex flex-col gap-3 mt-6 max-w-md">
                    <div className="flex flex-col gap-1.5 p-3 bg-muted/20 rounded-lg">
                        <Label htmlFor="email" className="text-xs font-semibold text-muted-foreground">Member Email</Label>
                        <Input
                            id="email"
                            type="text"
                    ...
                    <div className="flex flex-col gap-1.5 p-3 bg-muted/20 rounded-lg">
                        <Label htmlFor="firstname" className="text-xs font-semibold text-muted-foreground">Member Firstname</Label>
                        <Input
                            id="firstname"
                            type="text"
                    ...
                    <div className="flex flex-col gap-1.5 p-3 bg-muted/20 rounded-lg">
                        <Label htmlFor="surname" className="text-xs font-semibold text-muted-foreground">Member Surname</Label>
                        <Input
                            id="surname"
                            type="text"
                    ...
                    <Button className="mt-2" size="sm" onClick={handleEmailSubmission}>Continue</Button>
                </div>
            }
            {
                showRegistrationForm &&

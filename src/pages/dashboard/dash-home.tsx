        ...
        {!isLoading &&
            <div className="rounded-md overflow-x-scroll flex space-x-2">
                ...
                <Card className="flex-1">
                    ...
                    <CardContent>
                        <div className="text-center bg-muted rounded-full p-4 mx-auto w-12 h-12 justify-center items-center flex">{formatAmount(data?.total_registration_fees_due_by_pending_members, club?.currency)}</div>
                    </CardContent>
                </Card>
                ...
                <Card className="flex-1">
                    ...
                    <CardContent>
                        <div className="text-center bg-muted rounded-full p-4 mx-auto min-w-12 h-12 justify-center items-center flex">{formatAmount(data?.total_registration_fees_paid, club?.currency)}</div>
                    </CardContent>
                </Card>
                ...
                <Card className="flex-1">
                    ...
                    <CardContent>
                        <div className="text-center bg-muted rounded-full p-4 mx-auto w-12 h-12 justify-center items-center flex">{formatAmount(data?.total_extra_fees_owed_by_registered_members, club?.currency)}</div>
                    </CardContent>
                </Card>
            </div>
        }

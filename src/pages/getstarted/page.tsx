...
const steps = [
    {
        ...
        details: "Sign up with your email and create a secure account to get started with your club management journey.",
        action: "Sign Up Now",
        link: "/register",
    ...
    },
    {
        ...
        details: "Browse through our extensive catalog of clubs and find communities that align with your passions and goals.",
        action: "Browse Clubs",
        link: "/clubs",
    ...
    },
    {
        ...
        details: "Join your chosen clubs, meet like-minded people, and participate in exciting activities and events.",
        action: "Join a Club",
        link: "/clubs",
    ...
    },
    {
        ...
        details: "Access your dashboard, manage memberships, track activities, and watch your community engagement grow.",
                    ...
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        >
                            ...
                            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-12">
                                Join thousands of users who have transformed their club experience. Follow our simple 4-step process to unlock the full potential of community management.
                            </p>
                        </motion.div>
                        ...
                        >
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <span className="text-sm font-medium text-primary">0% Complete</span>
                            </div>
                            <Progress value={0} className="h-3 bg-muted/50" />
                            <p className="text-sm text-muted-foreground mt-2">Complete all steps to unlock your full potential</p>
                        </motion.div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="text-center mb-16">
                        ...
                        >
                            ...
                            <p className="text-muted-foreground max-w-2xl mx-auto">
                                Follow these carefully crafted steps to make the most of your club management experience
                            </p>
                        </motion.div>
                    </div>
                                        ...
                                        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
                                            ...
                                            <div className="flex items-center gap-4 flex-shrink-0">
                                                <div className="relative">
                                                    <div className={`w-16 h-16 rounded-full bg-gradient-to-r ${step.color} flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                                                        {step.icon}
                                                    </div>
                                            ...
                                            <div className="flex-1 space-y-4">
                                                ...
                                                <div className="flex items-center justify-between pt-4">
                                                    ...
                                                    <Button 
                                                        ...
                                                        className={`bg-gradient-to-r ${step.color} hover:opacity-90 shadow-md hover:shadow-lg transition-all duration-300 group/btn`}
                                                    >
                                                        {step.action}
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-6xl mx-auto">
                        ...
                        >
                            ...
                            <p className="text-muted-foreground max-w-2xl mx-auto">
                                Built with modern technology and designed for the future of club management
                            </p>
                        </motion.div>
                            ...
                            <CardContent className="p-12">
                                <div className="space-y-6">
                                    ...
                                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                        Join thousands of satisfied users and transform your club management experience today. It only takes a few minutes to get started.
                                    </p>
